...
public enum VariableType implements EnumCodeList.CodeListItem {
    ...
    DOC_CATEGORY1("文書区分1", "区分１", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_CATEGORY1"),
    DOC_CATEGORY2("文書区分2", "区分２", "親(区分1コード)", "", "", "", "", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_CATEGORY2"),
    DOC_SERVICE("サービス", "区分１", "区分２", "区分３", "区分４", "区分５", "区分６", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_SERVICE"),
    DOC_SERVICE1("事業領域", "事業領域", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_SERVICE1"),
    DOC_SERVICE2("サービス種別", "サービス種別", "親(事業領域コード)", "", "", "", "", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_SERVICE2"),
    DOC_SERVICE3("サービス", "サービス", "親(サービス種別コード)", "", "", "", "", "", "", "", "", "", "", "", "", "", "並び順", "", "", "", "", "", "", "CL_DOC_SERVICE3"),
